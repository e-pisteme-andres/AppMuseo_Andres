...
Documenta los recursos usados en el spike S-02 con `model-viewer`: biblioteca,
modelo de referencia, licencias, motivo de uso y forma correcta de servir las
paginas de prueba.

## Indice

- [Que hay, con su licencia](#qué-hay-con-su-licencia)
- [Modelo activo desde 2026-08-13](#modelo-activo-desde-2026-08-13)
- [Por que este modelo y no otro](#por-qué-este-modelo-y-no-otro)
- [Como se sirven](#cómo-se-sirven)
...
siga en curso; **cuando el spike se cierre, sus recursos pueden borrarse**. Son
6,5 MB que no tienen por qué quedarse en el repositorio para siempre.
...
Misma exigencia que en el resto de recursos del proyecto:
...
en [`modelos-s02-bacilo-esquematico.md`](./modelos-s02-bacilo-esquematico.md).
...
navegador ni siquiera ofrece el permiso. Ver la
[bitacora de decisiones](../principales/decisiones.md) y el
